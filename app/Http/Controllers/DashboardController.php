...
class DashboardController extends Controller
{
    public function index(): Response
    {
        ...
        // Today's stats - Cached for 5 minutes
        $stats = Cache::remember("dashboard_stats_outlet_{$outletId}", 300, function() use ($outletId) {
            ...
            return [
                ...
                'todaySalesTotal' => (float)($todaySales->total ?? 0),
